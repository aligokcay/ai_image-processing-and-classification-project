...
void process_images_in_directory(const char *input_dir, const char *output_dir) {
    ...
    while ((entry = readdir(dp)) != NULL) {
        ...
        }else if (strncmp(directory_name, "two", 3) == 0) {  // Eðer klasör adý "two" içeriyorsa
            snprintf(new_filename, sizeof(new_filename), "2");
        }else if (strncmp(directory_name, "three", 5) == 0) {  // Eðer klasör adý "three" içeriyorsa
            snprintf(new_filename, sizeof(new_filename), "3");
        } else {
...
int main() {
    ...
    const char *input3_directory = "two_train";
    const char *input4_directory = "three_train";
    const char *output1_directory = "train_set";
    
    const char *input5_directory = "zero_test";
    const char *input6_directory = "one_test";
    const char *input7_directory = "two_test";
    const char *input8_directory = "three_test";
    ...
    process_images_in_directory(input3_directory, output1_directory);
    process_images_in_directory(input4_directory, output1_directory);
    printf("train set: %d\n\n\n",data_size);
    
    process_images_in_directory(input5_directory, output2_directory);
    process_images_in_directory(input6_directory, output2_directory);
    process_images_in_directory(input7_directory, output2_directory);
    process_images_in_directory(input8_directory, output2_directory);
